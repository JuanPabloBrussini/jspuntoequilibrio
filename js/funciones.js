...
let rubros = document.getElementById('rubro').value;;
...
return {marcas, rubros, alquiler, servicios, sueldos, honorariosProf, honorariosGer, precioVenta, comisiones, cmv, iibb, gcias, gsadm, gsvs, percent}
...
const {marcas, rubros, alquiler, servicios, sueldos, honorariosProf, honorariosGer, precioVenta, comisiones, cmv, iibb, gcias, gsadm, gsvs, percent} = valores();
...
<div class="col s4">
<h5 class=puntounid>Punto de Equilibrio Ventas Unitario Mes es ${puntoEqUni.toLocaleString("es-ES")} unidades</h5>
</div>
<div class="col s4">
...
<div>
<h6 class=marca>Marca  ${marcaLocal}<h6>
<h6 class=rubro>Rubro  ${rubroLocal}<h6>
</div>
<div>
